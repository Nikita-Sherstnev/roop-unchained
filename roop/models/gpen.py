...
from roop.models.gpen_op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
...
if __name__ == '__main__':
    device = 'cuda'
    facegan = FaceGAN(base_dir='models', in_size=512, out_size=None, model='GPEN-BFR-512', channel_multiplier=2,
                      narrow=1, key=None, device=device)
    ...
    ef = facegan.process(cropped_face)
    import cv2
    cv2.imwrite('enhanced_face.jpg', ef)
...
class TestSwapFace:
    ...
    def test_GFPGAN_enhancement(self):
        ...
        process_mgr.initialize([face_set], [target_face], options)

        process_mgr.processors.insert(0, MockInsightFace(fake_frame))

        newframe = process_mgr.process_face(0, target_face, target_img)
